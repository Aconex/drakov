...
//                    logger.log('response: ' +originalResp.name, originalResp.body);
    ...
    action.examples.forEach(function(example){
        ...
        logger.log('Setup Route:', method.green, translatedUrl.yellow, (originalRequest && originalRequest.description ? originalRequest.description : action.name).blue);
